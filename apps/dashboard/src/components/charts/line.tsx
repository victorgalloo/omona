...
function LineSeriesStroke({
  ...
  // PATCH bklit: React 19 tipa useRef como RefObject<T | null>; en React 18
  // ese tipo no es asignable a LegacyRef. useRef<SVGPathElement>(null) ya
  // devuelve RefObject<SVGPathElement> aquí.
