...
export function HomeHero() {
  ...
  // —se va detrás del ancestro que sí tiene contexto— y el `bg-background` del
  // <div> que envuelve la página le pinta encima. Por eso ni la retícula ni el
  // campo de flujo se veían nunca.
  return (
