export const es = {
  ...
  hero: {
    ...
    companies: '200+ empresas confían en Omona',
    chat: [
  ...
  features: {
    ...
    crm: {
      ...
      subtitle: 'Integramos Twenty — el CRM open-source #1 — directamente en tu dashboard. Cada conversación del agente alimenta el pipeline en tiempo real.',
      bullet1: 'Pipeline visual: cada lead que atiende el agente aparece como oportunidad en el tablero, con etapa y valor.',
      bullet2: 'Contactos enriquecidos automáticamente: escuela, cargo y datos de contacto sin captura manual.',
