-- Consolidate webhook preprocessing into a single RPC call
-- Replaces 12 individual Supabase round trips with 1 call
--
-- Parameters:
--   p_phone      - The sender's phone number
--   p_name       - The sender's WhatsApp profile name
--   p_tenant_id  - UUID of the tenant (can be NULL for non-tenant messages)
--   p_is_test    - Whether this is a test phone number
--
-- Returns: JSONB with all context needed by the webhook handler
